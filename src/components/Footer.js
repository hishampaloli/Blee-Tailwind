...
const Footer = () => {
  return (
    <div className="w-full bg-[#4154F1] py-[4rem] p-10 text-white">
      <div className="max-w-[1240px] mx-auto flex flex-col ">
        <div>
          <h1 className="font-bold text-3xl text-white">Blee.</h1>
        ...
        <div className="w-full max-w-[700px] mt-10 flex justify-between">
          <div>
            <h6 className="font-medium text-gray-100 mb-4">USEFUL LINKS</h6>
            <ul>
          ...
          <div>
            <h6 className="font-medium text-gray-100 mb-4">Support</h6>
            <ul>
          ...
          <div>
            <h6 className="font-medium text-gray-100 mb-4">Company</h6>
            <ul>
